    ...
    <div className="flex flex-col w-full relative justify-end md:mx-4">
      <div className="h-[220px] w-full border-2 border-stone-300 rounded-3xl md:mx-2 drop-shadow-lg bg-white">
        <div className="flex justify-evenly">
          ...
          <div className="w-0.5 h-44 bg-zinc-200 my-auto"></div>
          <div className="flex flex-col">
            <p className="text-rose-400 text-xl md:text-2xl mx-auto font-semibold pt-4">
              POLLUTION
            </p>
            <div className="flex justify-start pt-2">
              <p className="text-black text-xl pt-2">PM2.5 AQI </p>
            ...
            <div className="flex justify-start pt-2">
              ...
              <p className="text-xl text-zinc-400 pt-4 pl-2"> 30 </p>
              <p className="text-sm text-zinc-400 pt-[22px] pl-1">min</p>
            </div>
